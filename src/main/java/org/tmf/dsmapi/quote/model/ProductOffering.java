 ...
 *         &lt;element name="bundledProductOffering" type="{http://orange.com/api/quoteManagement/tmf/v1/model/business}ProductOffering" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Serializable
{
    ...
    protected List<ProductOffering> bundledProductOffering;
     ...
     * 
     */
    @OneToMany(targetEntity = ProductOffering.class, cascade = {
        CascadeType.ALL
    })
    @JoinColumn(name = "BUNDLED_PRODUCT_OFFERING_PRO_0")
    public List<ProductOffering> getBundledProductOffering() {
        if (bundledProductOffering == null) {
            bundledProductOffering = new ArrayList<ProductOffering>();
        }
     ...
     * 
     */
    public void setBundledProductOffering(List<ProductOffering> bundledProductOffering) {
